...
Conduzir o loop de conversa em linguagem natural com o lead de seguro de veículo:
qualificar os dados necessários para cotar, extrair esses dados de forma estruturada, e
apresentar o resultado da cotação — incluindo as regras de negócio que a API não explica
sozinha (carência de 30 dias para roubo/furto, pro-rata do primeiro mês, agravo de
região) — sempre a partir de valores realmente devolvidos pela `/quote`, nunca calculados
ou estimados pelo LLM.
