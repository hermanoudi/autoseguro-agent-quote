...
Decidir, por critério determinístico e testado (`HandoffPolicy`), quando uma conversa
deve ser escalada para um vendedor humano — nunca deixando essa decisão a cargo do LLM —
e garantir que todo handoff acionado carregue um pacote de contexto completo com os
dados do lead já coletados e o motivo específico do gatilho.
